...
const TRIMORYN_DESTINATION_URL = 'https://www.sailgeneral.com/375Q8F6Z/23ZF853X/';

$fixedQueryKeys = [];
$fixedQuery = parse_url(TRIMORYN_DESTINATION_URL, PHP_URL_QUERY);
...
$destinationUrl = TRIMORYN_DESTINATION_URL;
if ($forwardedParams !== []) {
