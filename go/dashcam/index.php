...
const DASHCAM_DESTINATION_URL = 'https://www.sailgeneral.com/375Q8F6Z/218NP58S/';

$fixedQueryKeys = [];
$fixedQuery = parse_url(DASHCAM_DESTINATION_URL, PHP_URL_QUERY);
...
$destinationUrl = DASHCAM_DESTINATION_URL;
if ($forwardedParams !== []) {
